    ...
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        ...
        <img
          ...
          alt="Hero Image"
          loading="lazy"
          className="w-[500px] rounded-bl-3xl rounded-br-3xl rounded-tl-3xl rounded-tr-xl opacity-50 md:ml-auto animate__animated animate__fadeInUp animate__delay-4s"
        />
      </div>
      ...
      {/* Proyek */}
      <div className="proyek mt-30 py-10" id="proyek">
        <h1
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        ...
        <p
          className="text-center text-base/loose mb-10 opacity-50"
          data-aos="fade-up"
          data-aos-duration="1000"
          data-aos-delay="300"
          data-aos-once="true"
        ...
        <form
          action="https://formsubmit.co/benyaminsobirin17@gmail.com"
          method="POST"
        ...
        >
          <div className="flex flex-col gap-6">
            ...
            <div className="text-center">
              <button
                type="submit"
                className="bg-zinc-700 p-3 rounded-lg w-full cursor-pointer block border border-violet-600 hover:bg-violet-600"
              >
                Kirim Pesan
              </button>
            </div>
